    ...
    if event.type == KEYDOWN:
        ...
        if progress == 10:  # phase d'enquete
            ...
            # ---------------------------------------------------------------------------------------------------------
                ...
                elif playerX <= 210 and playerX >= 20 and Repeat == True:
                    toprint = dialogueFont.render("press e to inspect", True, (255, 255, 255))
                    screen.blit(toprint, (523, 417))
                    stopsign = True
                    pressE = True
...
#don't mind the part below                        
                        
                        
                pressE_policeman = False

                print("player x=", playerX)
                if playerX <= 1100 and playerX >= 1080:   #si le joueur est dans cette zone, et que c'est la première fois qu'on inspecte le pot de fleur, faire:

                    toprint = dialogueFont.render("press e to talk", True, (255, 255, 255))
                    pressE_policeman = True
                    policeman = True
                    screen.blit(toprint, (523, 417))
                    toprint = dialogueFont.render("press e to talk", True, (255, 255, 255))
                    pressE_policeman_print = True
                    screen.blit(toprint, (523, 417))
                    pygame.display.update()
