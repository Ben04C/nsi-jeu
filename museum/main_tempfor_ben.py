...
while running:
    ...
    if progress == 5:  # phase d'enquete
        ...
        # I HAVE TO FIX WHAT'S BELOW. I HAVE TO FIX THE EVENT.GET() CODE AS WELL AS THE E.TYPE == KEYDOWN AND MAKE THE INVENTORY
        # STAY ON SCREEN WHEN RELEASING THE TAB KEY.
        ...
        if event.type == KEYDOWN:
            if event.key == K_TAB and inventory == False:  # on vérifie si TAB est pressé et si l'inventaire est fermé
                ...
                screen.blit(inventaire, (320,
                                         40))  # L'image de l'inventaire s'affiche désormait à l'écran (inventaire est l'image, et inventory est le booléen!)
                pygame.display.update()
