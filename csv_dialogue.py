...
def dialogue():
    ...
    with open('assets/Dialogues/Stopsign.csv') as csvfile: #We open the csv file with the dialogues
        reader = csv.reader(csvfile, delimiter=',')
        for item in reader:
    ...
    with open('assets/Dialogues/Policeman_Before_Bush_Inspect.csv') as csvfile: #We open the csv file with the dialogues
        reader = csv.reader(csvfile, delimiter=',')
        for item in reader:
    ...
    with open('assets/Dialogues/Policeman_After_Bush_Inspect.csv') as csvfile: #We open the csv file with the dialogues
        reader = csv.reader(csvfile, delimiter=',')
        for item in reader:
